...
especialidad.grid(row=3, column=3, padx=5, pady=5)

LabelGenro=tk.Label(text="Genero:")
LabelGenro.grid(row=4, column=0, padx=5, pady=5, sticky="W")
...
comboTipo.grid(row=6, column=1, pady=5, padx=5)

genero=tk.StringVar()
genero.set("Masculino")
radioMasculino=ttk.Radiobutton( text="Masculino", variable=genero, value="Masculino")
radioMasculino.grid(row=7, column=1, padx=5, pady=5)
radioFemenino=ttk.Radiobutton(text="femenino", variable="genero", value="femenino")
radioFemenino.grid(row=8, column=1, padx=5, pady=5)

#Hospital
labehosp=tk.Label(text="Hospital: ")
labehosp.grid(row=9, column=0, padx=5, pady=5)
hospital=tk.Entry( state="readonly")
hospital.grid(row=10, column=5, pady=5, padx=5)
